...
const Log = () => {
    return (
      <div
        className="w-[700px] h-[700px] rounded-[100%] bg-[#505050] flex justify-start items-center text-[#fff] text-center float-right mt-[-700px] max-[1110px]:mt-[-200px] max-[1110px]:justify-center"
      >
