          ...
          <form className="w-[100%] flex flex-col">
            <input
              ...
              className={cn(
                ...
                errors.email && `border-[#ff3b3b] text-[#ff3b3b] placeholder-[#ff3434] focus:border-[#ff3b3b]`
              )}
              {...register("email")}
            />
            ...
            <input
              ...
              className={cn(
                ...
                max-[700px]:mb-[15px] max-[700px]:h-[50px] max-[700px]:text-[18px]`,
                errors.password && `border-[#ff3b3b] text-[#ff3b3b] placeholder-[#ff3434] focus:border-[#ff3b3b]`
              )}
              {...register("password")}
            />
            {errors.password && (
            ...
            <input
              ...
              className={cn(
                ...
                max-[700px]:mb-[15px] max-[700px]:h-[50px] max-[700px]:text-[18px]`,
                errors.confirmPassword && `border-[#ff3b3b] text-[#ff3b3b] placeholder-[#ff3434] focus:border-[#ff3b3b]`
              )}
          ...
          <form
            ...
            >
              ...
              className={cn(
                ...
                max-[700px]:mb-[15px] max-[700px]:h-[50px] max-[700px]:text-[18px]`,
                errors.phoneNumber && `border-[#ff3b3b] text-[#ff3b3b] placeholder-[#ff3434] focus:border-[#ff3b3b]`
              )}
              ...
              className={cn(
                ...
                max-[700px]:mb-[15px] max-[700px]:h-[50px] max-[700px]:text-[18px]`,
                errors.idNumber && `border-[#ff3b3b] text-[#ff3b3b] placeholder-[#ff3434] focus:border-[#ff3b3b]`
              )}
              {...register("idNumber")}
              />
              {errors.idNumber && (
