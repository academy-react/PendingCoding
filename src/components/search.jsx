  ...
  return (
    <div className="relative w-full">
      ...
      <input
        value={value}
        className={cn(
          "disabled:cursor-not-allowed outline-none bg-[#EEEEEE] text-gray-500 dark:text-gray-800 border-2 rounded-full duration-200 border-gray-300 focus:border-gray-400",
          className
        )}
