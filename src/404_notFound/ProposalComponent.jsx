...
const Proposal = ({to , title}) => {
  return (
    <div className="relative h-[87px] w-[clamp(100px,95%,489px)] border-solid border-[4px] border-[#A4A4A4] rounded-[200px] overflow-hidden mb-[30px]
    dark:border-gray-500
    
    max-[550px]:h-[60px]">
    <div className="w-[clamp(50px,100%,108px)] h-full bg-[#A4A4A4] 
