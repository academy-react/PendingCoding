...
const NotFound = () => {
  ...
  return (
    ...
    <div className="flex justify-center items-center flex-col p-[0_40px_150px] bg-[#EEEEEE]
    dark:bg-gray-800">
      ...
      <Link 
       to="/"
       className="
       bg-[#505050] cursor-pointer rounded-[50px] text-[18px] text-white w-[200px] p-[10px_0] text-center mb-[40px] hover:bg-[#A4A4A4] transition
