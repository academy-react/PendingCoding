import { Calendar, ChevronLeft, Clock, Eye, LayoutDashboard, MoveLeft, Tags, User2 } from "lucide-react";
...
export const VerticalCard = ({ blog }) => {
  const [year, month, day] = new Date(blog.startDate).toLocaleDateString("fa-IR-u-nu-latn").split("/")
      ...
      <div className="w-[350px] mx-auto flex flex-col items-center justify-center gap-y-5 bg-white rounded-t-3xl rounded-b-lg s  overflow-hidden">
        ...
        <div className="w-full px-5 flex justify-between items-center">
          ...
          <span className="text-gray-500 text-sm flex items-center justify-center gap-x-1">
            ...
            {`${getPersianNumbers(day)} ${months[month]} ${getPersianNumbers(year,true)}`}
          </span>
